...
void Renderer::CreateComputeDescriptorSetLayout() {
    ...
    // Describe the three bindings for blades
    ...
    // num blades
    VkDescriptorSetLayoutBinding bladesNumLayoutBinding = {};
    bladesNumLayoutBinding.binding = 2;
    bladesNumLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    bladesNumLayoutBinding.descriptorCount = 1;
    bladesNumLayoutBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    bladesNumLayoutBinding.pImmutableSamplers = nullptr;

    // group bindings
    std::vector<VkDescriptorSetLayoutBinding> bindings = {
        bladesLayoutBinding,
        bladesCulledLayoutBinding,
        bladesNumLayoutBinding
    };
...
void Renderer::CreateDescriptorPool() {
    ...
    std::vector<VkDescriptorPoolSize> poolSizes = {
        ...
        // Blades compute buffers - three buffers total
...
void Renderer::CreateGrassDescriptorSets() {
    ...
    // adapted from model descriptors
    ...
    for (uint32_t i = 0; i < scene->GetBlades().size(); ++i) {
        ...
        // populate descriptor set writes
...
void Renderer::CreateComputeDescriptorSets() {
    ...
    // adapt from CreateModelDescriptorSets
    ...
    for (uint32_t i = 0; i < scene->GetBlades().size(); ++i) {
        ...
        // blades after culling
        VkDescriptorBufferInfo bladeCulledBufferInfo = {};
        bladeCulledBufferInfo.buffer = scene->GetBlades()[i]->GetCulledBladesBuffer();
        bladeCulledBufferInfo.offset = 0;
        bladeCulledBufferInfo.range = sizeof(Blade) * NUM_BLADES;
        ...
        descriptorWrites[3 * i + 1].pBufferInfo = &bladeCulledBufferInfo;
        ...
        bladeNumBufferInfo.range = sizeof(BladeDrawIndirect) * NUM_BLADES;
