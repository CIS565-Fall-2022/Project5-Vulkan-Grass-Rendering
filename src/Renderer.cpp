...
void Renderer::CreateComputeDescriptorSetLayout() {
    ...
    VkDescriptorSetLayoutBinding remainBladesLayoutBinding = {};
    remainBladesLayoutBinding.binding = 2;
    remainBladesLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    remainBladesLayoutBinding.descriptorCount = 1;
    remainBladesLayoutBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    remainBladesLayoutBinding.pImmutableSamplers = nullptr;

    std::vector<VkDescriptorSetLayoutBinding> bindings = { grassBladesLayoutBinding, culledBladesLayoutBinding, remainBladesLayoutBinding };
...
void Renderer::CreateDescriptorPool() {
    ...
    std::vector<VkDescriptorPoolSize> poolSizes = {
        ...
        // Three blades buffer for compute descriptor
