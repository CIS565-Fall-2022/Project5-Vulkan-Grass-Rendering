...
void Renderer::CreateComputeDescriptorSetLayout() {
    ...
    VkDescriptorSetLayoutBinding grassLB = {};
    grassLB.binding = 0;
    grassLB.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    grassLB.descriptorCount = 1;
    grassLB.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    grassLB.pImmutableSamplers = nullptr;

    VkDescriptorSetLayoutBinding culledGrassLB = {};
    culledGrassLB.binding = 1;
    culledGrassLB.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    culledGrassLB.descriptorCount = 1;
    culledGrassLB.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    culledGrassLB.pImmutableSamplers = nullptr;

    VkDescriptorSetLayoutBinding nGrassLB = {};
    nGrassLB.binding = 2;
    nGrassLB.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    nGrassLB.descriptorCount = 1;
    nGrassLB.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    nGrassLB.pImmutableSamplers = nullptr;

    std::vector<VkDescriptorSetLayoutBinding> bindings = { grassLB, culledGrassLB, nGrassLB };
