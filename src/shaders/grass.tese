...
layout(location = 0) in vec4 in_baryCoord0[];
layout(location = 1) in vec4 in_baryCoord1[];
layout(location = 2) in vec4 in_baryCoord2[];
...
void main() {
    ...
    vec3 v0 = vec3(in_baryCoord0[0]);
    vec3 v1 = vec3(in_baryCoord1[0]);
    vec3 v2 = vec3(in_baryCoord2[0]);
